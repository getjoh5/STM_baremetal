...
/* Basic operations */
#define ST7789_RST_Clr() GPIO_PA4_OFF()
#define ST7789_RST_Set() GPIO_PA4_ON()

#define ST7789_DC_Clr() GPIO_PA3_OFF()
#define ST7789_DC_Set() GPIO_PA3_ON()
#ifndef CFG_NO_CS
#error CS control is not configured for this bare-metal port.
#else
